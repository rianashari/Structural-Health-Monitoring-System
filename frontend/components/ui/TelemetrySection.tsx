        ...
        <div className="flex-col gap-3">
            ...
            <div className="section-header">
                ...
                <div className="badge" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}>
                    <div className="status-dot teal"></div> <span className="text-secondary" style={{ fontSize: '0.65rem' }}>7 sensors active</span>
                </div>
            </div>
                    ...
                    <div className="status-main">
                        ...
                        <div className="flex-col" style={{ gap: '0.1rem' }}>
                            ...
                            <div className="font-extrabold flex items-center gap-3 text-primary text-sm">
                                <div className="status-dot green"></div> All Clear
                            </div>
                        </div>
                    </div>

                    <div className="status-tags">
                        <div className="status-tag"><Settings2 size={10} /> Parameters in Range</div>
                        <div className="status-tag"><Cpu size={10} /> Sensors Operational</div>
                        <div className="status-tag"><Wifi size={10} /> Network Stable</div>
                        <div className="status-tag"><Database size={10} /> Data Pipeline Active</div>
                    </div>
                </div>

                <div className="status-summary flex-col" style={{ gap: '0.1rem' }}>
                    <div className="status-summ-title">No active alerts</div>
                    <div className="status-summ-val"><span className="text-primary font-bold">0</span> warnings · <span className="text-primary font-bold">0</span> critical</div>
                </div>
            </div>

            {/* Sensor Grid - Redesigned Layout */}
            <div className="sensor-grid">

                {/* Main Sensor: Wind Speed (Left Column - Spans 2 Rows) */}
                <div className="sensor-card-main" style={{ gridRow: 'span 2', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div className="flex-col flex-1" style={{ marginTop: '2.5rem', justifyContent: 'center' }}>
                        ...
                        <div className="sensor-value-main">
                            0.00 <span className="sensor-unit">knot</span>
                        </div>
                        <div className="sensor-range">Max range: 19.44 knot</div>
                    </div>

                    <div style={{ marginTop: 'auto', paddingTop: '1.5rem' }}>
                        <div className="progress-labels">
                            <span>0 knot</span>
                            <span>19.44 knot</span>
                        </div>
                        <div className="progress-bar-container">
                            <div className="progress-bar-fill" style={{ width: '5%' }}></div>
                        </div>
                        <div className="flex items-center gap-2 font-bold" style={{ fontSize: '0.65rem', marginTop: '0.75rem', color: 'var(--accent-teal)' }}>
                            <div className="status-dot teal"></div> Within safe threshold
                        </div>
                    </div>
                </div>

                {/* Pitch Default State (Top Middle) */}
                ...
                {/* Roll Default State (Top Middle-Right) */}
                ...
                {/* Sway (Bottom Middle - Spans 2 cols) */}
                <div className="sensor-card" style={{ borderColor: 'rgba(14, 165, 233, 0.4)', gridColumn: '2 / span 2', gridRow: '2' }}>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-col" style={{ gap: '0.2rem' }}>
                                ...
                                <div className="sensor-value-small">
                                    52 <span className="sensor-unit-small">mm</span>
                                </div>
                            </div>
                        </div>
                ...
                {/* Total Tilt (Bottom Right) */}
                <div className="sensor-card" style={{ borderColor: 'rgba(244, 63, 94, 0.4)', gridColumn: '4', gridRow: '2' }}>
                    <div className="flex justify-between items-start w-full h-full">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-col" style={{ gap: '0.2rem' }}>
                                ...
                                <div className="sensor-value-small" style={{ fontWeight: 800 }}>
                                    0.057<span className="sensor-unit-small" style={{ marginLeft: '2px' }}>°</span>
                                </div>
                            </div>
                        </div>
